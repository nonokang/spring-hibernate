...
//			  ,width: '100%'	//默认自动调整
			  ...
			  ,url: '/spring-hibernate/people/list'	//异步获取数据
			  ,cols: [[
		  ...
		  table.on('tool(table-filter)', function(obj){
		    ...
		    if(obj.event === 'del'){//删除
		      layer.confirm('是否确认删除？', function(index){
	              ...
	              $.ajax({
	                    type: 'post',
	                    url: '/spring-hibernate/people/opera',
	                    dataType: 'json',
	                    data: {
	                    	ids : _ids.join(','),
	                    	type : '-1'	
		        ...
		        layer.open({
		          ...
		          ,maxmin: true
		          ,offset: [50,0] //模态框坐标
		          ,content: '/spring-hibernate/people/detail?id='+data.id
		         /*  ,btn: ['保存', '关闭'] //只是为了演示
			...
			batchDel: function(){ //批量删除
		  	...
		  	addData: function(){
		        layer.open({
			          ...
			          ,maxmin: true
			          ,offset: [50,0] //模态框坐标
			          ,content: '/spring-hibernate/people/detail'
			        });
		  	}
		    ,reload: function(){
